...
build:
	...
	@make exec "composer global require drupal/coder dealerdirect/phpcodesniffer-composer-installer mglaman/drupal-check phpunit/phpunit"
	@make exec 'export PATH="/var/www/.composer/vendor/bin"'
	@make exec "wget https://asm89.github.io/d/twig-lint.phar -P /var/www"
	@make install
